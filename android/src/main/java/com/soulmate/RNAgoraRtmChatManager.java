...
public class RNAgoraRtmChatManager {
    private static final String TAG = RNAgoraRtmChatManager.class.getSimpleName();

    private Context mContext;
    private RtmClient mRtmClient;
    private List<RtmClientListener> mListenerList = new ArrayList<>();

    public RNAgoraRtmChatManager(Context context) {
        mContext = context;
    }
